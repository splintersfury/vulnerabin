...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Napp_communicator_dll["**app_communicator.dll**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/app_communicator_dll.yml` then re-run the renderer._
