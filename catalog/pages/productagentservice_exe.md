...
flowchart TB
    subgraph ZSYSTEM["SYSTEM"]
        Nproductagentservice_exe["**productagentservice.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/productagentservice_exe.yml` then re-run the renderer._
