...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Nlghub_installer_2026_exe["**lghub_installer_2026.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/lghub_installer_2026_exe.yml` then re-run the renderer._
