...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Navast_free_setup_exe["**avast_free_setup.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/avast_free_setup_exe.yml` then re-run the renderer._
