# vkrnlintvsp_22621.4751_post.sys

(Auto-seeded; replace this description.) Catalogued in 1 engagement(s).

## At a glance

- **Binary**: `vkrnlintvsp_22621.4751_post.sys`
- **Binary Kind**: sys
...
flowchart TB
    ...
    subgraph Zkernel["kernel"]
        Nvkrnlintvsp_22621_4751_p["**vkrnlintvsp_22621.4751_post.sys**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| PRE 10.0.22621.2506 / POST 10.0.22621.4751 (Jan 2025 KB5050021) | 2026-05-04 | vkrnlintvsp-2026-05-04 | — | Auto-seeded from vkrnlintvsp-2026-05-04/scope.json (target: vkrnlintvsp.sys (Hyper-V NT Kernel Integration VSP)) |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/vkrnlintvsp_22621_4751_post_sys.yml` then re-run the renderer._
