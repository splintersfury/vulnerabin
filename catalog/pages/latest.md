...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nlatest["**latest**<br/>(this binary)"]:::self
    end
...
_62 relevant classes; 0 present · 0 defense observed · 0 not present · 62 unchecked_
...
|---------|------------|------------|--------|-------|
| 5.1.16.91 | 2026-03-30 | cisco-secure-client-2026-03-30 | — | Auto-seeded from cisco-secure-client-2026-03-30/scope.json (target: Cisco Secure Client - acsock64.sys) |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/latest.yml` then re-run the renderer._
