...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nmessaging_ipc_dll["**messaging_ipc.dll**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/messaging_ipc_dll.yml` then re-run the renderer._
