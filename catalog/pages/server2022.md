...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nserver2022["**server2022**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/server2022.yml` then re-run the renderer._
