...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Nupdater["**updater**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/updater.yml` then re-run the renderer._
