...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Ndiscoverysrv_exe["**discoverysrv.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/discoverysrv_exe.yml` then re-run the renderer._
