...
flowchart TB
    ...
    subgraph Zkernel["kernel"]
        Nbddci4_sys["**bddci4.sys**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/bddci4_sys.yml` then re-run the renderer._
