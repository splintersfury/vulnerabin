...
- **Binary**: `teamviewer_host_setup_x64_2026.exe`
- **Binary Kind**: exe
...
flowchart TB
    subgraph ZSYSTEM["SYSTEM"]
        Nteamviewer_host_setup_x6["**teamviewer_host_setup_x64_2026.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/teamviewer_host_setup_x64_2026_exe.yml` then re-run the renderer._
