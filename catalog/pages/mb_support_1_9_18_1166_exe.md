...
- **Binary**: `mb-support-1.9.18.1166.exe`
- **Binary Kind**: exe
...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nmb_support_1_9_18_1166_e["**mb-support-1.9.18.1166.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/mb_support_1_9_18_1166_exe.yml` then re-run the renderer._
