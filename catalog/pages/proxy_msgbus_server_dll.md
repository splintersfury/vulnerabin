...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nproxy_msgbus_server_dll["**proxy.msgbus.server.dll**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/proxy_msgbus_server_dll.yml` then re-run the renderer._
