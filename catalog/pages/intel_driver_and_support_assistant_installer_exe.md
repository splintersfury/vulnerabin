...
- **Binary**: `intel-driver-and-support-assistant-installer.exe`
- **Binary Kind**: exe
...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Nintel_driver_and_support["**intel-driver-and-support-assistant-installer.exe**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| — | 2026-04-30 | intel-dsa-2026-04-30 | — | — |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/intel_driver_and_support_assistant_installer_exe.yml` then re-run the renderer._
