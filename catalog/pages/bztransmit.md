...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Nbztransmit["**bztransmit**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/bztransmit.yml` then re-run the renderer._
