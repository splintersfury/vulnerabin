...
- **Binary**: `tvvirtualmonitordriver.dll`
- **Binary Kind**: dll
...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Ntvvirtualmonitordriver_d["**tvvirtualmonitordriver.dll**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/tvvirtualmonitordriver_dll.yml` then re-run the renderer._
