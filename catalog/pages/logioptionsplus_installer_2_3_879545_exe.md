# logioptionsplus_installer_2.3.879545.exe

(Auto-seeded; replace this description.) Catalogued in 1 engagement(s).

## At a glance

- **Binary**: `logioptionsplus_installer_2.3.879545.exe`
- **Binary Kind**: exe
...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Nlogioptionsplus_installe["**logioptionsplus_installer_2.3.879545.exe**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| — | 2026-05-07 | logitech-2026-05-07 | — | — |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/logioptionsplus_installer_2_3_879545_exe.yml` then re-run the renderer._
