# vid_26100.7920_feb2026_post.sys

(Auto-seeded; replace this description.) Catalogued in 1 engagement(s).

## At a glance

- **Binary**: `vid_26100.7920_feb2026_post.sys`
- **Binary Kind**: sys
...
flowchart TB
    ...
    subgraph Zkernel["kernel"]
        Nvid_26100_7920_feb2026_p["**vid_26100.7920_feb2026_post.sys**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| PRE 10.0.26100.5074 (Sept 2025) / POST 10.0.26100.7920 (Feb 2026 KB5077181) | 2026-05-09 | vid-2026-05-09 | — | Auto-seeded from vid-2026-05-09/scope.json (target: vid.sys (Hyper-V Virtualization Infrastructure Driver)) |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/vid_26100_7920_feb2026_post_sys.yml` then re-run the renderer._
