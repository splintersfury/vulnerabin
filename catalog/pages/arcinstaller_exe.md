...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Narcinstaller_exe["**arcinstaller.exe**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| stub-2026-04-30 | 2026-04-30 | bcny-arc-2026-04-30 | — | — |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/arcinstaller_exe.yml` then re-run the renderer._
