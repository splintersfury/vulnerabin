...
flowchart TB
    ...
    subgraph Zunknown["unknown"]
        Navast_free_offline_exe["**avast_free_offline.exe**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| — | 2026-04-30 | avast-avg-2026-04-30 | — | — |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/avast_free_offline_exe.yml` then re-run the renderer._
