# vkrnlintvsp_26100.1150_pre.sys

(Auto-seeded; replace this description.) Catalogued in 1 engagement(s).

## At a glance

- **Binary**: `vkrnlintvsp_26100.1150_pre.sys`
- **Binary Kind**: sys
...
flowchart TB
    ...
    subgraph Zkernel["kernel"]
        Nvkrnlintvsp_26100_1150_p["**vkrnlintvsp_26100.1150_pre.sys**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/vkrnlintvsp_26100_1150_pre_sys.yml` then re-run the renderer._
