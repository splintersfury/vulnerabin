...
- **Binary**: `teamviewer_virtualdevicedriver.dll`
- **Binary Kind**: dll
...
flowchart TB
    subgraph ZloggedInUser["loggedInUser"]
        Nteamviewer_virtualdevice["**teamviewer_virtualdevicedriver.dll**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/teamviewer_virtualdevicedriver_dll.yml` then re-run the renderer._
