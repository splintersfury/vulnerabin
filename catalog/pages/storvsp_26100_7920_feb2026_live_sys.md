# storvsp_26100.7920_feb2026_live.sys

(Auto-seeded; replace this description.) Catalogued in 1 engagement(s).

## At a glance

- **Binary**: `storvsp_26100.7920_feb2026_live.sys`
- **Binary Kind**: sys
...
flowchart TB
    ...
    subgraph Zkernel["kernel"]
        Nstorvsp_26100_7920_feb20["**storvsp_26100.7920_feb2026_live.sys**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| PRE 10.0.26100.7462 (Dec 2025) / POST 10.0.26100.7705 (Jan 2026, KB5074105) | 2026-05-05 | storvsp-2026-05-05 | — | Auto-seeded from storvsp-2026-05-05/scope.json (target: storvsp.sys (Hyper-V Storage VSP)) |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/storvsp_26100_7920_feb2026_live_sys.yml` then re-run the renderer._
