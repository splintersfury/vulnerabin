...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Nnordvpninstall_8_1_2_0_e["**nordvpninstall_8.1.2.0.exe**<br/>(this binary)"]:::self
    end
...
|---------|------------|------------|--------|-------|
| — | 2026-04-29 | nordsecurity-2026-04-29 | — | — |
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/nordvpninstall_8_1_2_0_exe.yml` then re-run the renderer._
