...
flowchart TB
    ...
    subgraph Zinstaller_elevated["installer-elevated"]
        Ninstall_backblaze_exe["**install_backblaze.exe**<br/>(this binary)"]:::self
    end
...
---
_Auto-generated by `scripts/catalog_render.py` at 2026-05-09 15:29 UTC. Edit `catalog/binaries/install_backblaze_exe.yml` then re-run the renderer._
