undefined8 *
FUN_140013950(undefined8 *param_1,ulonglong param_2,undefined8 param_3,ulonglong param_4,
             byte param_5)

{
  ...
  if (_Var8 < 0x1000) {
    ...
    if (pvVar6 == (void *)0x0) goto LAB_140013add;
  ...
  if (uVar3 < 0x10) {
    ...
    FUN_140031e00((undefined1 (*) [16])((longlong)puVar10 + uVar2),param_5,param_4);
    *(undefined1 *)((longlong)puVar10 + uVar2 + param_4) = 0;
  }
  else {
...
// FUNCTION_START: FUN_140013af0 @ 140013af0