longlong * FUN_1400261e0(float *param_1,longlong *param_2,byte *param_3)

{
  ...
  if (plVar7 != local_48) {
    ...
    while( true ) {
      ...
      if (local_48 ==
          *(longlong **)
           (*(longlong *)(param_1 + 6) + (uVar10 & *(ulonglong *)(param_1 + 0xc)) * 0x10)) break;
  ...
  *(undefined4 *)(plVar7 + 2) = *(undefined4 *)param_3;
  plVar7[3] = *(longlong *)(param_3 + 8);
  ...
  if (*param_1 < (float)(lVar8 + 1) / (float)uVar3) {
    ...
    uVar11 = uVar3;
    if ((uVar3 < uVar9) && ((0x1ff < uVar3 || (uVar11 = uVar3 * 8, uVar3 * 8 < uVar9)))) {
      uVar11 = uVar9;
    }
    FUN_140017450((longlong)param_1,uVar11);
    plVar4 = *(longlong **)
              (*(longlong *)(param_1 + 6) + 8 + (uVar10 & *(ulonglong *)(param_1 + 0xc)) * 0x10);
    local_48 = *(longlong **)pfVar1;
    if (plVar4 != local_48) {
...
LAB_140026402:
  ...
  *puVar5 = plVar7;
  ...
  plVar4 = *(longlong **)(lVar8 + uVar10 * 0x10);
  if (plVar4 == *(longlong **)pfVar1) {
    *(longlong **)(lVar8 + uVar10 * 0x10) = plVar7;
  }
  else {
    if (plVar4 == local_48) {
      *(longlong **)(lVar8 + uVar10 * 0x10) = plVar7;
    ...
    if (*(undefined8 **)(lVar8 + 8 + uVar10 * 0x10) != puVar5) goto LAB_140026472;
  }
  *(longlong **)(lVar8 + 8 + uVar10 * 0x10) = plVar7;
LAB_140026472:
...
// FUNCTION_START: FUN_140026490 @ 140026490