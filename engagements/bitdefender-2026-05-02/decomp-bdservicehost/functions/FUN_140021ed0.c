void FUN_140021ed0(longlong param_1)

{
  ...
  p_Var2 = DAT_14007d520;
  local_20 = DAT_14007d520;
  if (DAT_14007d660 == 0) {
    std::_Lockit::_Lockit(local_28,0);
    if (DAT_14007d660 == 0) {
      DAT_14007bdc0 = DAT_14007bdc0 + 1;
      DAT_14007d660 = (ulonglong)DAT_14007bdc0;
    }
    std::_Lockit::~_Lockit(local_28);
  }
  uVar3 = DAT_14007d660;
  lVar4 = *(longlong *)(param_1 + 8);
  if ((DAT_14007d660 < *(ulonglong *)(lVar4 + 0x18)) &&
     (*(longlong *)(*(longlong *)(lVar4 + 0x10) + DAT_14007d660 * 8) != 0)) goto LAB_140021fd7;
  lVar5 = 0;
  if (*(char *)(lVar4 + 0x24) == '\0') {
LAB_140021f8c:
    if (lVar5 != 0) goto LAB_140021fd7;
  }
  else {
    lVar4 = FUN_14002d9b4();
  ...
  if (p_Var2 == (_Facet_base *)0x0) {
    lVar4 = FUN_140025680((longlong *)&local_20,param_1);
    p_Var2 = local_20;
    if (lVar4 == -1) {
      FUN_140002320();
      pcVar1 = (code *)swi(3);
...
// FUNCTION_START: FUN_140022010 @ 140022010