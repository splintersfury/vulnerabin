undefined1 * FUN_140029c40(longlong *param_1,undefined1 *param_2,undefined1 *param_3)
  ...
  if (uVar7 <= 0xfffffffffffffff - (uVar7 >> 1)) {
    ...
    if (uVar11 < 0x1000000000000000) {
      ...
      if (_Var8 < 0x1000) {
        ...
        if (_Var8 + 0x27 <= _Var8) goto LAB_140029e04;
      ...
      *puVar10 = *param_3;
      *(undefined8 *)(puVar10 + 8) = *(undefined8 *)(param_3 + 8);
      *param_3 = 0;
...
// FUNCTION_START: FUN_140029e10 @ 140029e10