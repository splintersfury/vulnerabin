void FUN_1400192b0(undefined8 *param_1,uint param_2,undefined8 *param_3)

{
  ...
  FUN_1400106a0((longlong *)&local_78,(undefined8 *)"out_of_range",0xc);
...
// FUNCTION_START: FUN_1400194a0 @ 1400194a0