undefined8 *
FUN_140014ae0(undefined8 *param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (_Var7 < 0x1000) {
    ...
    if (pvVar6 == (void *)0x0) goto LAB_140014c41;
  ...
  param_1[3] = uVar9;
  if (uVar3 < 0x10) {
    FUN_1400316b0(puVar10,param_5,param_6);
    FUN_1400316b0((undefined8 *)((longlong)puVar10 + param_6),param_1,lVar2 + 1);
  }
  else {
    puVar4 = (undefined8 *)*param_1;
    FUN_1400316b0(puVar10,param_5,param_6);
    FUN_1400316b0((undefined8 *)((longlong)puVar10 + param_6),puVar4,lVar2 + 1);
...
// FUNCTION_START: FUN_140014c60 @ 140014c60