void FUN_14002b840(undefined8 *param_1,LPCWSTR param_2)

{
  ...
  wcsncpy_s(local_444,0x102,L"enable_service_autostart",0xffffffffffffffff);
  wcscat_s(local_444,0x104,L"()");
  wcsncpy_s(local_23c,0x104,L"enable_service_autostart",0xffffffffffffffff);
  ...
  if ((bool)local_468) {
    ...
    *param_1 = CONCAT44(uStack_49c,DVar3);
    ...
    param_1[2] = local_4e0;
    param_1[3] = CONCAT44(uStack_4d4,uStack_4d8);
    param_1[4] = local_4d0;
    ...
    *(undefined1 *)(param_1 + 6) = 1;
    ...
    if ((bool)local_458) {
      ...
      *(undefined1 *)(param_1 + 6) = 1;
      ...
      local_460 = pSVar4;
      FUN_14002b740(param_1,pSVar4,2);
    }
...
// FUNCTION_START: FUN_14002bba0 @ 14002bba0