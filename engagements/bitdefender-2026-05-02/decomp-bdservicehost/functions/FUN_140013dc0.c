undefined8 *
FUN_140013dc0(undefined8 *param_1,ulonglong param_2,undefined8 param_3,longlong param_4,
...
LAB_140013fa2:
  ...
  if (uVar8 < 0x1000) {
    ...
    if (uVar8 + 0x27 <= uVar8) goto LAB_140013fa2;
    pvVar6 = operator_new(uVar8 + 0x27);
    if (pvVar6 == (void *)0x0) goto LAB_140013f9c;
  ...
  if (uVar3 < 8) {
    ...
    FUN_1400316b0((undefined8 *)((longlong)puVar9 + (param_5 + param_4) * 2),
                  (undefined8 *)(uVar10 + (longlong)param_1),(lVar2 - param_4) * 2 + 2);
  }
  else {
    ...
    FUN_1400316b0((undefined8 *)((longlong)puVar9 + (param_5 + param_4) * 2),
                  (undefined8 *)(uVar10 + (longlong)puVar4),(lVar2 - param_4) * 2 + 2);
...
// FUNCTION_START: FUN_140013fd0 @ 140013fd0