void FUN_140028190(undefined8 *param_1,undefined1 *param_2)

{
  ...
  FUN_14001de50(local_48,'\0');
  local_38[0] = 5;
  local_30[0] = (undefined4)((longlong)(param_1[2] - param_1[1]) >> 3);
  if (param_1[0x15] == 0) goto LAB_1400284d1;
...
LAB_14002828e:
    ...
    *(undefined8 *)(param_2 + 8) = 0;
    ...
    cVar10 = *pcVar4;
    *pcVar4 = cVar9;
    local_30[0] = CONCAT31(local_30[0]._1_3_,cVar10);
    ...
    *(undefined8 *)(param_2 + 8) = uVar5;
    ...
    if (pcVar4 == (char *)0x0) goto LAB_14002828e;
    if (*pcVar4 == '\x02') {
      ...
      *(longlong *)(param_2 + 8) = lVar7 + -0x10;
      ...
      plVar6 = local_40;
      cVar9 = local_48[0];
      if ((uVar2 >> ((byte)uVar3 & 0x1f) & 1) == 0) goto LAB_14002828e;
      local_48[0] = '\0';
      local_40 = (longlong *)0x0;
  ...
  if (local_48[0] == '\x01') {
    ...
    if (local_48[0] != '\x03') goto LAB_1400284a7;
...
// FUNCTION_START: FUN_1400284e0 @ 1400284e0