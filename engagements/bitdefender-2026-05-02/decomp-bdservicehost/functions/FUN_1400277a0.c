void FUN_1400277a0(undefined8 *param_1,undefined1 *param_2,undefined8 *param_3)

{
  ...
  if (param_1[0x15] == 0) goto LAB_140027ae0;
...
LAB_14002789d:
    ...
    *(undefined8 *)(param_2 + 8) = uVar5;
    ...
    if (pcVar4 == (char *)0x0) goto LAB_14002789d;
    if (*pcVar4 == '\x02') {
      ...
      *(longlong *)(param_2 + 8) = lVar7 + -0x10;
      ...
      plVar6 = local_40;
      cVar9 = local_48[0];
      if ((uVar2 >> ((byte)uVar3 & 0x1f) & 1) == 0) goto LAB_14002789d;
      local_48[0] = '\0';
      local_40 = (longlong *)0x0;
  ...
  if (local_48[0] == '\x01') {
    ...
    if (local_48[0] != '\x03') goto LAB_140027ab6;
...
// FUNCTION_START: FUN_140027af0 @ 140027af0