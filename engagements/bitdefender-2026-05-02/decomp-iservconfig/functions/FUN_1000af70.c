void __fastcall FUN_1000af70(undefined4 *param_1,uint param_2,uint *param_3)

{
  ...
  local_4c = param_1;
  local_48 = param_2;
  FUN_10008e70(local_64,(uint *)"out_of_range",0xc);
  local_14 = 0;
...
LAB_1000b054:
    ...
    if ((uint)((int)local_7c[0] + (-4 - (int)pvVar2)) < 0x20) goto LAB_1000b054;
LAB_1000b142:
    FUN_10032f7f();
LAB_1000b147:
    FUN_10032f7f();
...
LAB_1000b05e:
  ...
  if (0xf < local_50) {
    ...
    if (0xfff < local_50 + 1) {
      ...
      if (0x1f < (uint)((int)local_64[0] + (-4 - (int)pvVar2))) goto LAB_1000b142;
    }
    FUN_1002e346(pvVar2);
  }
  ...
  *param_1 = nlohmann::detail::out_of_range::vftable;
  if (0xf < local_2c._4_4_) {
    ppppuVar4 = (undefined4 ****)local_3c;
    if (0xfff < local_2c._4_4_ + 1) {
      ppppuVar4 = (undefined4 ****)local_3c[-1];
      if (0x1f < (uint)((int)local_3c + (-4 - (int)ppppuVar4))) goto LAB_1000b147;
    }
...
// FUNCTION_START: FUN_1000b150 @ 1000b150