void __cdecl FUN_10008520(_Facet_base *param_1)

{
  ...
  if (DAT_1006b6b0 == 0) {
    ...
    if (DAT_1006b6b0 == 0) {
      ...
      DAT_1006b6b0 = DAT_1006a8c0;
    }
    FUN_1002c986((int *)&local_18);
  }
  uVar1 = DAT_1006b6b0;
  iVar2 = *(int *)(param_1 + 4);
  if ((DAT_1006b6b0 < *(uint *)(iVar2 + 0xc)) &&
     (*(int *)(*(int *)(iVar2 + 8) + DAT_1006b6b0 * 4) != 0)) goto LAB_10008646;
  iVar5 = 0;
  if (*(char *)(iVar2 + 0x14) == '\0') {
LAB_100085d1:
    if (iVar5 != 0) goto LAB_10008646;
  }
  else {
    iVar2 = FUN_1002cb0b();
  ...
  if (p_Var3 == (_Facet_base *)0x0) {
    ...
    *(undefined ***)p_Var3 =
         std::
         num_put<wchar_t,class_std::ostreambuf_iterator<wchar_t,struct_std::char_traits<wchar_t>_>_>
         ::vftable;
...
// FUNCTION_START: FUN_10008670 @ 10008670