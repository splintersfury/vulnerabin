void __fastcall FUN_1000abb0(undefined4 *param_1,uint param_2,uint *param_3)

{
  ...
  local_4c = param_1;
  local_48 = param_2;
  FUN_10008e70(local_64,(uint *)"invalid_iterator",0x10);
  local_14 = 0;
...
LAB_1000ac94:
    ...
    if ((uint)((int)local_7c[0] + (-4 - (int)pvVar2)) < 0x20) goto LAB_1000ac94;
LAB_1000ad82:
    FUN_10032f7f();
LAB_1000ad87:
    FUN_10032f7f();
...
LAB_1000ac9e:
  ...
  if (0xf < local_50) {
    ...
    if (0xfff < local_50 + 1) {
      ...
      if (0x1f < (uint)((int)local_64[0] + (-4 - (int)pvVar2))) goto LAB_1000ad82;
    }
    FUN_1002e346(pvVar2);
  }
  ...
  *param_1 = nlohmann::detail::invalid_iterator::vftable;
  if (0xf < local_2c._4_4_) {
    ...
    if (0xfff < local_2c._4_4_ + 1) {
      ...
      if (0x1f < (uint)((int)local_3c + (-4 - (int)ppppuVar4))) goto LAB_1000ad87;
    }
...
// FUNCTION_START: FUN_1000ad90 @ 1000ad90