void __thiscall FUN_1001a030(void *this,undefined1 *param_1,undefined4 *param_2)
    ...
    *param_1 = 0;
    ...
    if (*(int *)((int)this + 4) == *(int *)((int)this + 8)) {
      ...
      *(undefined4 *)(param_1 + 4) = uVar4;
      ...
      if (pcVar3 == (char *)0x0) goto LAB_1001a294;
      if (*pcVar3 == '\x02') {
        ...
        *(int *)(param_1 + 4) = iVar5 + -0x10;
        ...
        cVar7 = local_30[0];
        if ((uVar2 & 1 << ((byte)uVar10 & 0x1f)) == 0) goto LAB_1001a294;
        uVar4 = (undefined4)local_28;
        uVar8 = local_28._4_4_;
...
// FUNCTION_START: FUN_1001a2d0 @ 1001a2d0