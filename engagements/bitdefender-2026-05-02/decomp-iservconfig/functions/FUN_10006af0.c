void __thiscall
FUN_10006af0(char *param_1,undefined4 *param_2,undefined4 param_3,int *param_4,int param_5,
...
LAB_10006bec:
  ...
  pcVar3 = std::num_put<char,class_std::ostreambuf_iterator<char,struct_std::char_traits<char>_>_>::
           _Ffmt(this,param_1,(char)local_1c,0);
  ppppcVar5 = local_34;
  if (0xf < local_20) {
...
// FUNCTION_START: FUN_10006cc0 @ 10006cc0