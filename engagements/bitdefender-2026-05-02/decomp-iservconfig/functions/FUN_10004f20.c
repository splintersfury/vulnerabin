undefined8 __thiscall FUN_10004f20(void *this,uint *param_1,uint param_2,int param_3)
  ...
  if ((-1 < param_3) && ((0 < param_3 || (param_2 != 0)))) {
    do {
      ...
      if (lVar7 < 1) {
        ...
        sVar1 = (**(code **)(*this + 0xc))((short)*param_1);
        if (sVar1 == -1) break;
        bVar6 = uVar4 != 0;
        uVar4 = uVar4 - 1;
        iVar2 = 2;
        ...
        uVar3 = (uint)lVar7;
        FUN_100301d0((uint *)**(undefined4 **)((int)this + 0x20),param_1,uVar3 * 2);
        iVar2 = uVar3 * 2;
        bVar6 = uVar4 < uVar3;
        uVar4 = uVar4 - uVar3;
...
// FUNCTION_START: FUN_10005010 @ 10005010

/* WARNING: Removing unreachable block (ram,0x1000505b) */
/* WARNING: Removing unreachable block (ram,0x10005065) */