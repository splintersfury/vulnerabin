int * __thiscall FUN_1002b770(void *this,ushort param_1)

{
  ...
  if (local_34 != '\0') {
    ...
    pcVar5 = (char *)FUN_1001ab10(pvVar3,&local_40,iVar6,(uint)*(ushort *)(iVar6 + 0x40),
                                  (uint)param_1,local_40,*(undefined4 *)(iVar6 + 0x38));
    uVar8 = 4;
    if (*pcVar5 == '\0') {
      uVar8 = 0;
    }
...
// FUNCTION_START: Catch_All@1002b84f @ 1002b84f